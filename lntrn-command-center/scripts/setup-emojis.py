...
Run ONCE:
    python3 lntrn-command-center/scripts/setup-emojis.py
...
DATA_RS = CRATE_ROOT / "src" / "emojis" / "data.rs"
...
def main() -> int:
    ...
    with DATA_RS.open("w") as f:
        f.write("//! Auto-generated by lntrn-command-center/scripts/setup-emojis.py.  DO NOT EDIT BY HAND.\n")
