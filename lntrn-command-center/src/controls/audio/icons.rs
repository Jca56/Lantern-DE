...
pub(super) fn draw_speaker_colored(
    ...
    painter.rect_filled(Rect::new(bx0, by0, bx1 - bx0, by1 - by0), 0.0, color);
...
pub(super) fn draw_mic(
    ...
    let neck_h = 0.18 * h;
    painter.rect_filled(Rect::new(neck_x, neck_top, neck_w, neck_h), 0.0, color);
