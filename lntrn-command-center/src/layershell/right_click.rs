...
pub(super) fn handle_right_click(wl: &mut WlState, app: &mut AppState, text: &mut TextRenderer) {
    if !wl.right_clicked {
        return;
    }
    ...
    match app.mode {
        crate::app::PanelMode::Launcher if app.panel_view == crate::app::PanelView::Default => {
        ...
        crate::app::PanelMode::Launcher if app.panel_view == crate::app::PanelView::Terminal => {
            ...
            .is_some()
            {
                ...
                if app.terminal.has_selection() {
                    ...
                    items.push(crate::launcher::context_menu::MenuItem {
                        ...
                        action: crate::launcher::context_menu::MenuAction::TerminalClearSelection,
                    });
                }
                items.push(crate::launcher::context_menu::MenuItem {
                    label: "Paste".into(),
        ...
        crate::app::PanelMode::Launcher if app.panel_view == crate::app::PanelView::Files => {
            let panel_rect = lntrn_render::Rect::new(panel.x, panel.y, panel.w, panel.h);
            let top_y = crate::controls::content_top_y(panel_rect, scale_f);
