...
pub fn title_bar_h(s: f32) -> f32 { TITLE_BAR_H * s }
...
pub fn title_bar_rect(width: f32, s: f32) -> Rect {
    Rect::new(0.0, 0.0, width, TITLE_BAR_H * s)
}

pub fn nav_bar_y(s: f32) -> f32 {
    (TITLE_BAR_H + GRADIENT_H) * s
}
...
pub fn tab_bar_y(s: f32) -> f32 {
    (TITLE_BAR_H + GRADIENT_H + NAV_BAR_H + GRADIENT_H) * s
}
...
pub fn content_top(s: f32) -> f32 {
    (TITLE_BAR_H + GRADIENT_H + NAV_BAR_H + GRADIENT_H + TAB_BAR_H) * s
}
