...
fn palette(mode: &WindowMode) -> TabPalette {
    match mode {
        ...
        WindowMode::Lantern => TabPalette {
            ...
            close_inactive_fg: Color::from_rgba8(120, 50, 20, 255),
            plus_bg: Color::from_rgba8(240, 230, 210, 12),
            plus_bg_hover: Color::from_rgba8(240, 230, 210, 35),
            plus_border: Color::from_rgba8(240, 230, 210, 40),
            plus_icon: Color::from_rgba8(140, 120, 90, 255),
            plus_icon_hover: Color::from_rgba8(240, 230, 210, 255),
            ctx_shadow: Color::from_rgba8(0, 0, 0, 60),
            ctx_bg: Color::from_rgba8(35, 28, 18, 255),
            ctx_highlight: Color::from_rgba8(240, 230, 210, 15),
            ctx_top_line: Color::from_rgba8(240, 230, 210, 15),
        },
    }
}
